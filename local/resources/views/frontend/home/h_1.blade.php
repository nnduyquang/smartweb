<div id="h_1" style="background-image: url({{URL::asset('images/bg/slider-2-1.jpg')}});">
    <div class="computer-slider position-relative" style="overflow: hidden;">
        <img src="{{URL::asset('images/bg/computer_2.png')}}" alt=""
             style="z-index: 1;width: 60%;height: auto;float: right;position: absolute;-webkit-animation: mymove 1s;

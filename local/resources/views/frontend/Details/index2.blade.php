            ...
            <div class="row">
                ...
                <div class="col-md-7 text-center">
                    <div class="position-relative" style="width: 90%;border: 1px solid #f2f0f0;padding: 2px;margin: auto">
                        <img src="{{URL::asset('images/tkweb/webmau2.jpg')}}" alt=""
                             style="width: 100%;height: auto;">

                        <img src="{{URL::asset('images/Banner/iphone_2.png')}}"
                             alt=""
                             style="position: absolute;right: -25%;top:50%;height: 60%;width: auto;transform: translateY(-50%)">
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 pb-4 mb-3" style="border-bottom:1px dashed #888888">
                            <ul>
                                ...
                                <li>
                                    Điểm pagespeed <span class="text-success">88/100</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 mb-5">
                    ...
                    <img src="{{URL::asset('images/Banner/Macbook-PNG-Picture2.png')}}" alt="" style="width: 100%;height: auto;margin: auto">


                        <br>
                        <img src="{{URL::asset('images/Banner/iphone_2.png')}}" alt="" style="width: 100%;height: auto;">
                    </div>
                </div>

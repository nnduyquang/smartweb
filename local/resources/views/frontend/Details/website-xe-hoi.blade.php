        ...
        <div class="row">
            ...
            <div class="col-md-7 text-center">
                <div class="position-relative" style="width: 90%;border: 1px solid #f2f0f0;padding: 2px;margin: auto">
                    <img src="{{URL::asset('images/Banner/web-xe-hoi.jpg')}}" alt=""
                         style="width: 100%;height: auto;">

                    <img src="{{URL::asset('images/Banner/iphone_3.png')}}"
                         alt=""
            ...
            <div class="col-md-5 pt-1 mb-3" style="border-bottom:1px dashed #888888">
                <div class="row">
                    ...
                    <div class="col-md-12 pb-4 mb-4" style="border-bottom:1px dashed #888888">
                        <h1>WEBSITE XE HƠI</h1>
                        <span>Mẫu website : <span class="text-danger">#103</span></span><br>
                    ...
                    <div class="col-md-12" style="border-bottom:1px dashed #888888">
                        ...
                        <ul class="li_linhvuc">
                            <li><a href="">Bán Ô Tô</a></li>
                            <li><a href="">Công Nghệ & Dịch Vu</a></li>
                            <li><a href="">Phụ Kiện Ô Tô</a></li>
                            <li><a href="">Sửa chửa Ô Tô</a></li>
                            <li><a href="">Linh kiện Ô Tô</a></li>
                        </ul>
        ...
        <div class="row">
            <div class="col-md-7 mb-5">
                ...
                <div style="width: 90%;margin: auto">
                    <img src="{{URL::asset('images/Banner/Macbook-PNG-Picture3.png')}}" alt="" style="width: 100%;height: auto;margin: auto">

                    <br>
                    <img src="{{URL::asset('images/Banner/iPad-PNG-Transparent-3.png')}}" alt="" style="width: 80%;height: auto;margin:2% 10%">

                    <br>
                    <img src="{{URL::asset('images/Banner/iphone_3.png')}}" alt="" style="width: 100%;height: auto;">
                </div>
            </div>
...
@include('frontend.Details.quick_contact')
@endsection
        ...
        <div id="h_static" class="row">
            ...
            <div class="col-lg-3 text-center col-md-6 pb-3 col-12 d-flex align-items-center justify-content-center">
                ...
                <div class="counter_area d-flex flex-column justify-content-center pl-3">
                    <span id="counter-number1" data-from="1" data-to="150" data-speed="1000">
                        </span>
            ...
            <div class="col-lg-3 text-center col-md-6 pb-3 col-12 d-flex align-items-center justify-content-center">
                ...
                <div class="counter_area d-flex flex-column justify-content-center pl-3">
                    <span id="counter-number2" data-from="1" data-to="150" data-speed="1000">
                        </span>
            ...
            <div class="col-lg-3 text-center col-md-6 pb-3 col-12 d-flex align-items-center justify-content-center">
                ...
                <div class="counter_area d-flex flex-column justify-content-center pl-3">
                    <span id="counter-number3" data-from="1" data-to="150" data-speed="1000">
                        </span>
            ...
            <div class="col-lg-3 text-center col-md-6 pb-3 col-12 d-flex align-items-center justify-content-center">
                ...
                <div class="counter_area d-flex flex-column justify-content-center pl-3">
                    <span id="counter-number4" data-from="1" data-to="150" data-speed="1000">
                        </span>
